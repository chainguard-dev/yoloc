module github.com/chainguard-dev/yoloc
...
// replace github.com/eth0izzle/shhgit => github.com/tstromberg/sshgit v0.2.1

replace github.com/eth0izzle/shhgit => github.com/tstromberg/shhgit v0.2.1
